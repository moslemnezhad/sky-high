      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-5">
            ...
            <NavLink
              to="/contact"
              className="bg-[#0B2D4D] hover:bg-[#143e63] text-white px-6 py-3 rounded-lg font-semibold transition duration-300"
            >
              Book Consultation
            </NavLink>
        ...
        <div className="lg:hidden bg-white border-t">
          ...
          <div className="px-6 py-6 space-y-5">
            ...
            <NavLink
              to="/contact"
              onClick={() => setMenuOpen(false)}
              className="block text-center bg-[#0B2D4D] text-white py-3 rounded-lg"
            >
              Book Consultation
            </NavLink>
